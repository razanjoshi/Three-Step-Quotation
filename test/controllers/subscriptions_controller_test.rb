...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { daily_rate: @subscription.daily_rate, name: @subscription.name } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { daily_rate: @subscription.daily_rate, name: @subscription.name } }
